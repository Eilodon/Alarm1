...
class NoteListForDayScreen extends StatelessWidget {
  ...
  const NoteListForDayScreen({super.key, required this.date});
  ...
  Widget build(BuildContext context) {
    ...
    if (dayNotes.isEmpty) {
      return Scaffold(
        ...
        body: Center(child: Text(AppLocalizations.of(context)!.noNotesForDay)),
      );
    }
                ...
                children: [
                  ...
                  if (note.tags.isNotEmpty) ...[
                    ...
                    Wrap(
                      ...
                      runSpacing: 4,
                      children: note.tags
                          .map((t) => HintChip(label: t, onPressed: () {}))
                          .toList(),
                    ),
                  ],
                ],
